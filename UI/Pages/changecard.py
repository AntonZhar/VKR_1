...
class ChangeCard:
    ...
    def change_card(self, pg: PageData):
        def back(e):
        ...
        def add_policy(e):
            ...
            self.__crud.change_policy_db(full_data, pg.page.session.get('creds'), pg.page.session.get('policy_id'), False)
        ...
        def build_fields():
            ...
            self.__fields = [
                ...
                ft.TextField(label='Страхователь (ФИО)', on_change=set_policy_holder,
                             value=self.__crud.get_agent_by_id(datas[3])),
                ft.TextField(label='Код страхователя', disabled=True, value=datas[3]),
                ft.TextField(label='Номер телефона страхователя', value=policy_holder[4]),
                ft.TextField(label='Марка', value=car[0]),
                ft.TextField(label='Модель', value=car[1]),
                ft.TextField(label='Год выпуска', value=car[2]),
                ft.TextField(label='Пробег, км', value=car[3]),
                ft.TextField(label='VIN-номер', value=car[4]),
                ft.TextField(label='Гос. номер', value=car[5]),
                ft.TextField(label='Собственник', value=car[6]),
                ft.TextField(label='Мощность л/с', value=car[7]),
                ft.TextField(label='СТС', value=car[8]),
                ft.Dropdown(label='Условие владение', options=[ft.dropdown.Option('Собственность')], value=car[9]),
                ft.Dropdown(label='Цель использования', options=[ft.dropdown.Option('Личное')], value=car[10]),
        ...
        pg.page.title = 'Изменить карточку полиса' # название страницы
